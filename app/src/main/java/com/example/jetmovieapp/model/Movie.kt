...
// making a data class for all the information about our MovieModels
// inside it we gonna pass the info regarding MovieModels that we
// gonna populate and then display
...
// this function will help us retrieve and insert the
// data

fun getMovie(): List<Movie> {

    // returning
    // DO NOT PUT = WITH RETURN
